...
def handle_coin(chat_id, coin_query, message_id=None):
    ...
    # Fetch market data and news in parallel for maximum speed
    future_market = executor.submit(CryptoMarketData.get_coin_overview, coin_query)
    ...
    future_news = executor.submit(CryptoNewsFetcher.get_news_for_coin, market_data["name"], market_data["symbol"], 3)
    ...
    while True:
        try:
            ...
            for u in updates:
                ...
                executor.submit(process_single_update, u)
